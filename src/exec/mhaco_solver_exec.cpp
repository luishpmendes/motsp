...
int main (int argc, char * argv[]) {
    ...
    if(arg_parser.option_exists("--instance")) {
        ...
        unsigned initial_individual_method = 0;
        ...
        if(arg_parser.option_exists("--initial-individuals-method")) {
            initial_individual_method = std::stoul(
        ...
        if(initial_individual_method == 1) {
        ...
        } else if (initial_individual_method == 2) {
        ...
        std::cerr << "./mhaco_solver_exec "
                  ...
                  << "--focus <focus> "
                  << "--memory "
                  << "--initial-individuals-method <initial_individual_method> "
